...
public class TranhNgoc {
    ...
    public static final byte HOUR_REGISTER = 13;
    public static final byte MIN_REGISTER = 33;
    public static final byte HOUR_OPEN = 13;
    public static final byte MIN_OPEN = 41;

    public static final byte HOUR_CLOSE = 18;
